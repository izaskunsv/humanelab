      ...
      <style>{`
        ...
        *:focus-visible { outline: 3px solid #0D5C9E !important; outline-offset: 2px !important; border-radius: 4px !important; }
        ...
        @media (max-width: 768px) {
          ...
          .humane-sidebar { width: 100% !important; min-width: unset !important; border-right: none !important; border-bottom: 1.5px solid #C8C6BC !important; padding: 16px !important; }
          ...
          {tool.tags.map((tag) => (
            <li key={tag} style={{ listStyle: "none" }}>
              <span style={Object.assign({}, s.tagChip, { background: TAG_META[tag] && TAG_META[tag].bg, color: TAG_META[tag] && TAG_META[tag].text })}>
                {TAG_META[tag] && TAG_META[tag].label[lang]}
              </span>
            </li>
          ))}
        </ul>
...
const s = {
  ...
  navSection: { fontSize: 11, fontWeight: 700, color: "#5A5855", textTransform: "uppercase", letterSpacing: "0.07em", padding: "0 8px", marginBottom: 4, margin: 0 },
  ...
  eyebrow: { fontSize: 12, fontWeight: 700, color: "#5A5855", textTransform: "uppercase", letterSpacing: "0.08em", display: "block", marginBottom: 12, margin: "0 0 12px" },
